                ...
                <div class="panel-body">
                    <form method="post" action="<?=current_url()?>">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="start_date" autocomplete="off" class="form-control datepicker" value="<?=$item['start_date']?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="help-block">დასრულების თარიღი</label>
                            <div>
                                <input type="text" name="end_date" autocomplete="off" class="form-control datepicker" value="<?=$item['end_date']?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div>
                                <input class="form-control" name="max_responses" value="<?=$item['max_responses']?>"></input>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="radio radio-info radio-inline">
                                                    ...
                                                    <?php if($item['active_'.$lang["code"].''] == '1') { echo "checked"; } ?> > >
                                                    <label for="radioY_<?=$lang['code']?>">დიახ</label>
                                                </div>
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="radioN_<?=$lang['code']?>" name="active_<?=$lang['code']?>" value="0" 
                                                    <?php if($item['active_'.$lang["code"].''] == '0') { echo "checked"; } ?> >
