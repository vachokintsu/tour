        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-heading">
                    <a href="<?=site_url('admin/poll')?>/create" class="btn btn-primary">
                        <i class="fa fa-plus"></i> დამატება
                    </a>
                </div>
                <div class="panel-body">
                    <form action="<?=site_url('admin/poll')?>" method="get" class="hpanel clearfix">
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-striped table-bordered table-hover" width="100%">
                            <thead>
                                <tr>
                                    <th>სათაური</th>
                                    <th class="text-center">რესპოდენტთა რაოდენობა</th>
                                    <th class="text-center">თარიღი</th>
                                    <th class="text-center">რედაქტირება</th>
                                    <th class="text-center">პასუხები</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                            <?=($row['max_responses'] === Null) ? $row['response_count'] . " / ულიმიტო": 
                                                                                  $row['response_count'] . ' / '.$row['max_responses'] ?>
                                    </td>
                                    <td class="text-center" width="10%">
                                        <?=$row['start_date']?> -დან <br>
                                    ...
                                    <td class="text-center">
                                        <a href="<?=site_url('admin/'.$this->uri->segment(2).'/answers/'.$row['id'])?>" class="btn btn-xs btn-info edit">
