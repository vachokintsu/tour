        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-heading">
                    <a href="<?=site_url('admin/google_forms')?>/create" class="btn btn-primary">
                        <i class="fa fa-plus"></i> დამატება
                    </a>
                </div>
                <div class="panel-body">
                    <form action="<?=site_url('admin/google_forms')?>" method="get" class="hpanel clearfix">
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tbody>
                                <?php if(count($google_forms) < 1) { ?>
                                <tr>
                                    <td colspan="5">შედეგი ვერ მოიძებნა!</td>
                                </tr>
                                <?php } ?>
                                <?php foreach($google_forms as $row): ?>
                                <tr>
                                    <td>
                                        <?=$row['title_ge']?>
                                    </td>
