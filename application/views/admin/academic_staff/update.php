                ...
                <div class="panel-body">
                    <form method="post" action="<?=current_url()?>">
                        <div class="form-group">
                            ...
                            <div>
                                <select class="form-control m-b" name="facult" required>
                                    ...
                                    <option value="<?=$facult['id']?>" <?php if($facult['id'] == $item['facult_id']) echo "selected"; ?> >
                                        <?=$facult['title_ge']?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <select class="form-control m-b" name="direction" required>
                                    ...
                                    <option value="<?=$direction['id']?>" <?php if($direction['id'] == $item['direction_id']) echo "selected"; ?> >
                                        <?=$direction['title_ge']?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone[]" class="form-control" data-role="tagsinput" value="<?=$item['phone']?>">
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="control-label" for="email">ელ. ფოსტა</label>
                            <input type="text" name="email[]" class="form-control" data-role="tagsinput" value="<?=$item['email']?>">
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="help-block">Facebook</label>
                            <div>
                                <input type="text" name="facebook" class="form-control" maxlength="255"  value="<?=$item['facebook']?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="linkedin" class="form-control" maxlength="255" value="<?=$item['facebook']?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div>
                            ...
                            <div class="tab-content">
                                <?php $i = 1; foreach($langs as $lang): $code = $lang['code'];?>
                                <div id="tab-<?=$i?>" class="tab-pane fade <?php if($i == 1) { echo 'in active'; } ?>">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label class="help-block">სახელი</label>
                                            <div>
                                                <input type="text" name="title_<?=$lang['code']?>" class="form-control" maxlength="255" <?=($i == 1) ? 'required' : ''; ?> value="<?=$item["title_$code"]?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="help-block">გვარი</label>
                                            <div>
                                                <input type="text" name="fname_<?=$lang['code']?>" class="form-control" maxlength="255" <?=($i == 1) ? 'required' : ''; ?> value="<?=$item["fname_$code"]?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="help-block">წოდება</label>
                                            <div>
                                                <input type="text" name="rank_<?=$lang['code']?>" class="form-control" maxlength="255" <?=($i == 1) ? 'required' : ''; ?> value="<?=$item["rank_$code"]?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="help-block">კაბინეტის მისამსართი</label>
                                            <div>
                                                <input type="text" name="cabinet_<?=$lang['code']?>" class="form-control" maxlength="255" <?=($i == 1) ? 'required' : ''; ?> value="<?=$item["cabinet_$code"]?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="help-block">CV</label>
                                            <div>
                                                <textarea class="editor" id="editor_<?=$lang['code']?>" name="cv_<?=$lang['code']?>">
                                                    <?=$item["cv_$code"]?>
                                                </textarea>
                                            </div>
                                        </div>
