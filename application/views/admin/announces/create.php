            	...
            	<div class="panel-body">
	                <form method="post" action="<?=current_url()?>">
		                <div class="form-group">
		                    ...
		                    <div>
		                    	<input type="text" name="start_date" autocomplete="off" class="form-control" id="datetimepicker" required>
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div>
		                    	<input type="text" name="end_date" autocomplete="off" class="form-control" id="datetimepicker2">
		                    </div>
		                </div>
		                <div class="hr-line-dashed"></div>
		                <div>
