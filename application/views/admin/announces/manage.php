        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-heading">
                    <a href="<?=site_url('admin/announces')?>/create" class="btn btn-primary">
                        <i class="fa fa-plus"></i> დამატება
                    </a>
                </div>
                <div class="panel-body">
                    <form action="<?=site_url('admin/announces')?>" method="get" class="hpanel clearfix">
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-striped table-bordered table-hover" width="100%">
                            <thead>
                                <tr>
                                    <th>სათაური</th>
                                    <th class="text-center">დაწყება/დასრულება</th>
                                    <th class="text-center">რედაქტირება</th>
                                    <th class="text-center">წაშლა</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if(count($announces) < 1) { ?>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label class="label label-warning"><?=$row['start_date']?></label> / <label class="label label-warning"><?=$row['end_date']?></label>
                                    </td>
                                    <td class="text-center">
